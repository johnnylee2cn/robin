...
////将路由对象添加到服务器对象上
//
//sever.addRoutes(routes)
//
//routes.add(method: .get, uri: "/login") { (request, response) in
//    response.setBody(string: "我是/login消息")
//    response.completed()
//}
...
func handler(data: [String:Any]) throws -> RequestHandler {
	return {
		...
		response.appendBody(string: "<html><title>Hello, world!</title><body><h3>Hello, hello!</h3></body></html>")
